...
(123456789, 'RHEA', 'SHARMA', '123 MAIN STR, MUMBAI, MH', 4356789345, 35, 'F', 'ADMINISTRATION', 'RECEPTIONIST', '', 'DAY', '', 'Chhatrapati Shivaji Maharaj International Airport'),
(333445555, 'PAURAS', 'SINGH', '638 MAIN STREET, MUMBAI, MH', 9834561995, 40, 'M', 'ADMINISTRATION', 'SECRETARY', '', 'NIGHT', '', 'Chhatrapati Shivaji Maharaj International Airport'),
(999887777, 'PARTH', 'SETHI', '3321 MAIN STREET, DELHI, DL', 9834666995, 50, 'M', 'TECHNICIAN', 'RADIO Techinician', '', 'DAY', '', 'Indira Gandhi International Airport'),
(987654321, 'SHUBHAM', 'KUNDU', '123 MAIN STR, BANGALORE, KN', 8089654321, 47, 'M', 'FLIGHT MONITOR', '', '', 'DAY', '', 'Kempegowda International Airport'),
(666884444, 'KSHTIJ', 'SAXENA', '345 MAIN STREET, AHEMDABAD, GJ', 1254678903, 55, 'M', 'FLIGHT MONITOR', '', '', 'NIGHT', '',  'Sardar Vallabhbhai Patel International Airport'),
(453453453, 'RAJ', 'SRIVASTAVA', '345 MAIN STREET, CHENNAI, TL', 4326789031, 35, 'M', 'AIRPORT AUTHORITY', 'MANAGER', '', 'DAY', '',  'Chennai International Airport'),
(987987987, 'NIKITA', 'PAUL', '110 MAIN STR, KOLKATA, WB', 5678904325, 33, 'F', 'TECHNICIAN', 'AIRPORT CIVIL Techinician', '', 'NIGHT', '',  'Netaji Subhas Chandra Bose International Airport'),
(888665555, 'PRIYA', 'GUPTA', '567 MAIN STREET, DELHI, DL', 8566778890, 39, 'F', 'ADMINISTRATION', 'DATA ENTRY WORKER', '', 'NIGHT', '',  'Indira Gandhi International Airport'),
(125478909, 'PRATIK', 'GARG', '334 MAIN STREET, PUNE, MH', 4444678903, 56, 'M', 'FLIGHT MONITOR', '', '', 'DAY', '',  'Pune International Airport'),
(324567897, 'ADIT', 'ANAND', '987 MAIN STR, INDORE, MP', 2244658909, 36, 'M', 'FLIGHT MONITOR', '', '', 'DAY', '',  'Devi Ahilya Bai Holkar Airport');
