...
function BasicButtonExample() {
  ...
  <h1 class="display-4">Soaring Skies: Unlocking the Best Fares with Data Precision</h1>
  <p class="lead">
    Please fill your desired information for the fields given below and find the best possible price for your journey. We aim to leverage travel data and provide our customers with the best possible pricing prediction.
  </p>
